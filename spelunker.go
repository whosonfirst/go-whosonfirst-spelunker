...
www/server.py:@app.route("/500", methods=["GET"])
www/server.py:@app.route("/500/", methods=["GET"])
www/server.py:@app.route("/", methods=["GET"])
www/server.py:@app.route("/about", methods=["GET"])
www/server.py:@app.route("/about/", methods=["GET"])
www/server.py:@app.route("/faq", methods=["GET"])
www/server.py:@app.route("/faq/", methods=["GET"])
www/server.py:@app.route("/help", methods=["GET"])
www/server.py:@app.route("/help/", methods=["GET"])
www/server.py:@app.route("/id/<int:id>", methods=["GET"])
www/server.py:@app.route("/id/<int:id>/", methods=["GET"])
www/server.py:@app.route("/id/<int:id>.png", methods=["GET"])
www/server.py:@app.route("/id/<int:id>.geojson", methods=["GET"])
www/server.py:@app.route("/id/<int:id>.json", methods=["GET"])
www/server.py:@app.route("/recent", methods=["GET"])
www/server.py:@app.route("/recent/", methods=["GET"])
www/server.py:@app.route("/recent/facets", methods=["GET"])
www/server.py:@app.route("/recent/facets/", methods=["GET"])
www/server.py:@app.route("/recent/<int:days>", methods=["GET"])
www/server.py:@app.route("/recent/<int:days>/", methods=["GET"])
www/server.py:@app.route("/recent/<int:days>/facets", methods=["GET"])
www/server.py:@app.route("/recent/<int:days>/facets/", methods=["GET"])
www/server.py:@app.route("/current", methods=["GET"])
www/server.py:@app.route("/current/", methods=["GET"])
www/server.py:@app.route("/current/facets", methods=["GET"])
www/server.py:@app.route("/current/facets/", methods=["GET"])
www/server.py:@app.route("/random", methods=["GET"])
www/server.py:@app.route("/random/", methods=["GET"])
www/server.py:@app.route("/brands", methods=["GET"])
www/server.py:@app.route("/brands/", methods=["GET"])
www/server.py:@app.route("/brands/<int:id>", methods=["GET"])
www/server.py:@app.route("/brands/<int:id>/", methods=["GET"])
www/server.py:@app.route("/brands/<int:id>/facets", methods=["GET"])
www/server.py:@app.route("/brands/<int:id>/facets/", methods=["GET"])
www/server.py:@app.route("/download/<int:id>", methods=["GET"])
www/server.py:@app.route("/download/<int:id>/", methods=["GET"])
