...
// GetTags retrieves the list of unique tags in a Spelunker index in an SQLSpelunker database.
func (s *SQLSpelunker) GetTags(ctx context.Context) (*spelunker.Faceting, error) {
	return nil, spelunker.ErrNotImplemented
}

// HasTag retrieves the list of records that have a given tag in an SQLSpelunker database.
...
// HasTagFaceted retrieves faceted properties for records that have a given tag in an SQLSpelunker database.
