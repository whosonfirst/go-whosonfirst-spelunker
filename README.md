...
Once a decision has been reached on that matter and everything is proven to work this package (and all the related packages, discussed below) will be bumped up to a "version 2.x" release, reflecting the fact that the original Python version of the Spelunker is "version 1" and that this version is meaningfully different.
